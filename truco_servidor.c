...
void *thread_leitura(void *arg){
	...
	sprintf(client_name, "<span font_weight='bold' color='%s'>client %d: </span>", cores[client_socket_index % 2], client_socket_index);
